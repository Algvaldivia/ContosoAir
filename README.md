[![Build Status](https://dev.azure.com/AGomezANet/ContosoAir/_apis/build/status%2FAlgvaldivia.ContosoAir?branchName=master)](https://dev.azure.com/AGomezANet/ContosoAir/_build/latest?definitionId=11&branchName=master)
